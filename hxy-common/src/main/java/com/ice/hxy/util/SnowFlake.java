...
public class SnowFlake {
     ...
     */
    private long twepoch = 1685104656692L;
    ...
    public static long getSnowLong() {
        SnowFlake worker = new SnowFlake(random.nextInt(31), random.nextInt(31), random.nextInt(31));
        return worker.nextId()+random.nextInt(20000);
    }

    public static long getSnowLong(long sequence) {
        SnowFlake worker = new SnowFlake(random.nextInt(31), random.nextInt(31), sequence);
        return worker.nextId()+random.nextInt(20000);
    }
