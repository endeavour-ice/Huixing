...
public class GlobalExceptionHeader  {
    ...
    public B<ErrorCode> NoRouteToHostException(Exception e) {
        log.error("NoRouteToHostException: {}",e.getMessage());
