...
import com.ice.hxy.mapper.MessageMqMapper;
import com.ice.hxy.mode.entity.MessageMq;
...
public class SaveMessageMq {
    ...
    private boolean save(Message message,String error) {
        String messageId = message.getMessageProperties().getClusterId();
        ...
        try {
            ...
            messageMq.setMessageId(Long.valueOf(messageId));
